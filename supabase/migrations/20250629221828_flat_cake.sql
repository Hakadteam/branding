/*
  # Complete Database Setup for Hakad Digital Lab Portfolio
  ...
  2. Security
    ...
    - Public insert policies for contacts and newsletter
    - Public read policies for projects and testimonials
    - Admin management policies for authenticated users
...
DROP POLICY IF EXISTS "Admin can manage newsletter subscribers" ON newsletter_subscribers;
...
DELETE FROM projects WHERE client IN ('TechStore Inc.', 'DataFlow Solutions', 'CloudTech Pro');
DELETE FROM testimonials WHERE company IN ('TechStore Inc.', 'DataFlow Solutions', 'CloudTech Pro');
